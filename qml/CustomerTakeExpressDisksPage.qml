...
Rectangle{
        id:main_page
        Component.onCompleted: {
            root.customer_take_express_disks_result.connect(handle_result_disks_info)
        }
        Component.onDestruction: {

            root.customer_take_express_disks_result.disconnect(handle_result_disks_info)
        }

        function handle_result_disks_info(text){
            console.log(text)
            if(text == "Success"){
    ...
    //失败系统操作提示
        ...
        Component.onCompleted: {
            root.customer_take_express_disks_result_message.connect(show_message)
        }
        Component.onDestruction: {
            root.customer_take_express_disks_result_message.disconnect(show_message)
        }
